...
- `ai-spring-boot-starter` 支持通过 `eaf.registry`、`eaf.project`、`eaf.capability` 主动注册业务项目、心跳和能力。
...
2. 读取 `eaf.project.code`、`eaf.registry.appKey`、`eaf.registry.appSecret`。
