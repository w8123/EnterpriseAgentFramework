package com.enterprise.ai.skill.generated.aitextretrieval;
...
@Slf4j
@Component
public class AiTextRetrievalClient {

    private final RestClient restClient;
    private final ObjectMapper objectMapper = new ObjectMapper();

    public AiTextRetrievalClient(@Value("${skill.ai-text-retrieval.base-url:http://localhost:8080}") String baseUrl) {
    ...
    private String buildUri(String pathTemplate, Map<String, Object> pathVariables, Map<String, Object> queryParameters) {
        String resolvedPath = "/ai" + pathTemplate;
