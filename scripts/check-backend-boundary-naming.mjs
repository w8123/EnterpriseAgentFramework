...
assertIncludes('docs/architecture/service-table-ownership.md', '`skill_interaction`')
...
assertIncludes('sql/init.sql', '当前归属 reachai-knowledge-service')
assertIncludes('sql/init.sql', '当前归属 reachai-model-service')
assertNotIncludes('sql/init.sql', '对应 ai-skills-service')
assertNotIncludes('sql/init.sql', '对应 ai-model-service')
