...
import com.enterprise.ai.agent.capability.catalog.semantic.context.SemanticContext;
import com.enterprise.ai.agent.capability.catalog.semantic.context.SemanticContextCollector;
import com.enterprise.ai.agent.capability.catalog.semantic.llm.SemanticLlmClient;
import com.enterprise.ai.agent.capability.catalog.semantic.llm.SemanticLlmClient.SemanticGenerationResult;
import com.enterprise.ai.agent.capability.catalog.semantic.prompt.PromptTemplateRegistry;
import com.enterprise.ai.agent.capability.catalog.scan.ScanProjectToolAdapter;
