package com.enterprise.ai.agent.capability.catalog.semantic.context;
...
public record SemanticContext(
    ...
    /** 与 {@link com.enterprise.ai.agent.capability.catalog.semantic.SemanticDocEntity#LEVEL_SCAN_TOOL} 一致 */
