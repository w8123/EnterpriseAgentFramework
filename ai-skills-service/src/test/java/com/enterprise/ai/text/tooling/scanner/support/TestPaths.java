...
public final class TestPaths {
    ...
    public static Path skillsServiceModuleRoot() {
        return repoRoot().resolve("ai-skills-service");
    }

    public static Path scannerResource(String relativePath) {
        return skillsServiceModuleRoot().resolve("src/test/resources/tooling/scanner").resolve(relativePath).normalize();
    }
}
